...
const Footer = () => {
	...
	return (
		<div>
			<Toaster />
			<aside className="mt-0 text-center py-10">
			...
			<footer
				className="footer footer-center p-10 bg-transparent bottom-0 text-secondary-content"
				id="footer"
			>
				<div className="flex gap-20 w-4/5 justify-between h-full">
					<div className="flex gap-4 flex-col items-center justify-start h-full">
						...
						<a
							className="link text-[1.5vw] no-underline droidserif hover:underline"
							onClick={() => {
								navigate("/faq");
							}}
						>
				...
				<div className="w-1/3">
					<div className="form-control w-full">
						<label className="label">
							<span className="label-text underline uppercase droidserif text-[1.5vw] droidserif">
								Sign up for Updates
							</span>
						</label>
				...
				<nav className="text-secondary-content">
					<div className="flex flex-wrap justify-center items-center gap-16 w-2/3 lg:w-fit">
						...
						<a href="https://www.instagram.com/luxuriant_luxebeauty">
