    ...
    for (let i = 0; i < data.length; i++) {
      ...
      for (let j = 0; j < data[i].product_category.length; j++) {
        if (data[i].product_category.length !== 0) {
          product_category.push(data[i].product_category[j].category_name);
        }
      }
      ...
      if (
        ...
        if (!holidayProducts.some((product) => product._id === data[i]._id)) {
      ...
      if (
        ...
        if (!featuredProducts.some((product) => product._id === data[i]._id)) {
      ...
      if (
        ...
        if (
          !essentialsProducts.some((product) => product._id === data[i]._id)
        ) {
      ...
      if (
        product_category.some((category) => category.toLowerCase() === "hair")
      ) {
        if (!hairProducts.some((product) => product._id === data[i]._id)) {
      ...
      if (
        product_category.some((category) => category.toLowerCase() === "skin")
      ) {
        if (!skinProducts.some((product) => product._id === data[i]._id)) {
      ...
      if (
        ...
        if (!cosmeticsProducts.some((product) => product._id === data[i]._id)) {
      ...
      if (
        product_category.some((category) => category.toLowerCase() === "sample")
      ) {
        if (!sampleProducts.some((product) => product._id === data[i]._id)) {
      ...
      if (
        ...
        if (
          !beforeCheckoutProducts.some((product) => product._id === data[i]._id)
        ) {
