  ...
  useEffect(() => {
    if (product !== undefined) {
      ...
      if (product.product_image_links.description_images) {
        setSelectedImage(product.product_image_links.description_images[0]);
      }
      ...
      <div>
          ...
          <div className="flex-1 flex flex-col gap-2">
                  ...
                  {product.product_volumes !== "" && (
                    <div>
                      <div className="garbata">
                        ...
                        {(selectedVolume?.volume * 0.033814).toFixed(2)} fl oz
                      </div>
                    </div>
                  )}
                </div>
                  ...
                  {product.product_shades
                    ...
                    .map((shade) => (
                      ...
                      <div
                        ...
                        onClick={() => {
                          setSelectedProductShade(shade);
                          setSelectedImage(shade.shade_image);
                        }}
                      >
                        {shade.shade_number}
                      </div>
                  ...
                  {product.product_volumes.map((volume) => (
                    ...
                    <div
                      ...
                      onClick={() => {
                        ...
                        setSelectedProductCost(volume.volume_cost);
                      }}
                    >
                      {volume.volume} ml
                    </div>
            ...
            <div className="flex flex-col gap-2">
              <div className="flex flex-row gap-2 items-center">
                ...
                >
                  {detailsVisible ? <IconMinus /> : <IconPlus />}
                </div>
              </div>
              {detailsVisible && (
                <div className="text-2xl garbata">
                  {product.product_description.product_description !== "" && (
                    <div>
                      <div className="garbata">{product.product_details}</div>
                    </div>
                  )}
                </div>
              )}
            ...
            <div className="flex flex-col gap-2">
              <div className="flex flex-row gap-2 items-center">
                <div className="text-2xl garbata">Ingredients</div>
                <div
                  className="text-2xl garbata"
                  onClick={() => {
                ...
                >
                  {ingredientsVisible ? <IconMinus /> : <IconPlus />}
                </div>
              </div>
              {ingredientsVisible && (
                <div className="text-2xl garbata">
            ...
            {product.product_image_links && (
              <div className="w-1/2 flex justify-center p-8 m-4">
                <div className="aspect-square">
                  <ProductCarousel
                    images={product.product_image_links.description_images}
                  />
                </div>
              </div>
            )}
          ...
          <div className="flex flex-row-reverse justify-between ">
            {product.product_image_links && (
              <div className="w-1/2 flex justify-center p-8 m-4">
                <div className="aspect-square">
                  <ProductCarousel
                    images={product.product_image_links.real_results_images}
                  />
                </div>
              </div>
            )}
        ...
        <div className="flex justify-center flex-col items-center gap-4">
          <div className="flex flex-row gap-2">
            {[1, 2, 3, 4, 5].map((star) => (
              <IconStarFilled
                className={`w-16 h-16 ${
                  star <= ProductStars ? "text-brown-500" : "text-gray-300"
                }`}
              />
            ))}
          </div>
            ...
            productReviews.map((review) => (
              <div className="flex flex-col gap-4 p-4 mx-16 bg-transparent rounded-3xl my-2">
                <div className="flex flex-col items-start justify-start">
                  ...
                  <div className="text-3xl my-2 garbata">{review.review}</div>
                </div>
                <div className="flex flex-row justify-between">
                  <div className="text-3xl garbata">{review.review_date}</div>
                </div>
              </div>
            ))}
        </div>
        ...
        <dialog id="my_modal_1" className="modal">
          <div className="modal-box">
            ...
            <p className="py-4">What did you think about our product?</p>
            <div className="modal-action w-full justify-center flex">
              <form method="dialog" className="w-full">
                <div className="flex flex-col justify-between w-full">
                  ...
                  <div>
                    <label className="text-2xl garbata my-2">Review</label>
                  </div>
                  <div className="text-2xl garbata w-full">
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="text-2xl garbata my-2">Rate on 5!</label>
                  </div>
                  <div className="text-2xl garbata">
                    <input
                      type="number"
