    ...
    <div className="">
      ...
      <div className="flex flex-col">
        ...
        <div className="text-4xl px-16 py-4 text-center garbata italic">
          Indulge in the power of high-octane, active ingredient formulas that
          will leave your skin glowing like a radiant goddess. Our best-selling
          and versatile products are designed to work their magic on all skin
          types, giving you a youthful, rejuvenated appearance. Give your cells
          the joy they deserve and start your journey to healthy, glowing skin
          today!
        </div>
      </div>
        ...
        <div className="flex justify-center flex-row">
          <div
            className="p-4 m-8 mb-0 justify-center items-start text-4xl bodoni
				md:text-7xl"
          >
            LUXURIANT LUXE <span className="montserrat italic">Essentials</span>
          </div>
        </div>
      ...
      <section className="flex flex-col w-screen my-6 ">
        ...
        <div className="flex justify-center">
          <div className="text-8xl bodoni tangerine text-center px-16 garbata italic w-full translate-x-20">
            ...
            <div className="bodoni text-right w-3/4 font-normal">~LL</div>
          </div>
            ...
            <button
              ...
              onClick={() => {
                ...
                navigate("/category/holiday", {
                  state: {
                    currentCategoryProducts: HolidayProducts,
                  },
                });
              }}
            >
        ...
        <div className="flex justify-center w-full">
          <div className="w-full mx-4">
            {HolidayProducts && <DisplayCarousal products={HolidayProducts} />}
          </div>
        </div>
      ...
      >
        ...
        <div className="flex justify-center m-8">
          <div className="w-5/6 text-3xl italic garbata">
            Unveil the sublime secrets of skincare that honor the essence of
            your unique beauty. For true radiance stems not from a generic mold,
            but from the sacred symphony of your individuality. Behold the
            LUXURIANT LUXE, an exclusive range of expertly crafted potions that
            embrace your skin's intrinsic character and empower its natural
            faculties. With each elixir, your skin awakens to its full
            potential, embarking on a transformative journey towards
        ...
        <div className="flex justify-center m-8">
          <div className="w-5/6 text-3xl italic garbata">
            Indulge in the power of high-octane, active ingredient formulas that
            will leave your skin glowing like a radiant goddess. Our
            best-selling and versatile products are designed to work their magic
            on all skin types, giving you a youthful, rejuvenated appearance.
            Give your cells the joy they deserve and start your journey to
