    ...
    <div>
      ...
      <div className="text-xl m-16">
        ...
        >
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                "We", "Us" or "Our" in this Agreement) refers to Luxuriant luxe,
                fc road.
              </p>
            </li>
            <li>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to luxuriant luxe, accessible
                from{" "}
                <a
                  href="www.luxurianatluxe.com"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  www.luxurianatluxe.com
                </a>
              </p>
            </li>
            <li>
          ...
          <ul>
            <li>
              <p>By email: luxeluxurinat@gmail.com</p>
            </li>
            <li>
              <p>
                By visiting this page on our website:{" "}
                <a
                  href="www.luxurinatluxe.com"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  www.luxurinatluxe.com
                </a>
              </p>
            </li>
            <li>
              <p>By phone number: 7666018928</p>
            </li>
          </ul>
        </div>
      </div>
