  ...
  return (
    <div id="products_div">
      ...
      <section className="flex flex-col w-screen my-6 ">
        ...
        <div className="flex justify-center w-full">
          <div className="w-full mx-4">
            {productInfo && <DisplayCarousal products={productInfo} />}
          </div>
        </div>
      ...
      <section className="flex flex-col w-screen my-6 ">
        <div className="flex justify-between flex-row">
          <div
            className="p-4 m-18 mx-16 justify-center items-start text-4xl forum
				md:text-7xl"
          >
            <span className="text-accent bodoni mx-4 text-center">LL Hair</span>
          </div>
          <div>
            <button
              className="text-accent underline btn btn-ghost btn-lg p-4 m-8 forum text-4xl"
        ...
        <div className="text-4xl px-24 garbata py-4">
          These are the products that are essential for your daily skin. They
          are recommended by our experts and are the best in the market. These
          are the products that are essential for your daily skin. They are
          recommended by our experts and are the best in the market.
        </div>
        <div className="flex justify-center w-full">
          <div className="w-full mx-4">
            {HairProducts && <DisplayCarousal products={HairProducts} />}
          </div>
        </div>
        {/* <div className="flex justify-center w-10/12 self-center">
					<div className="text-4xl px-16 garbata py-4 text-center ">
      ...
      <section className="flex flex-col w-screen my-6 ">
        <div className="flex justify-between flex-row">
          <div
            className="p-4 m-8 mx-16 justify-center items-start text-4xl forum
				md:text-7xl"
          >
            <span className="text-accent bodoni mx-4 text-center">LL Skin</span>
          </div>
          <div>
            <button
              className="text-accent underline btn btn-ghost btn-lg p-4 m-8 forum text-4xl"
        ...
        <div className="flex justify-center w-full">
          <div className="w-full mx-4">
            {SkinProducts && <DisplayCarousal products={SkinProducts} />}
          </div>
        </div>
        {/* <div className="flex justify-center w-10/12 self-center">
					<div className="text-4xl px-16 garbata py-4 text-center ">
