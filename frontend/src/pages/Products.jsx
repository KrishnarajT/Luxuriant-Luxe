    ...
    <div id="products_div">
      ...
      >
        <div className="text-xl mt-4 garbata text-center md:text-3xl w-3/4">
          Tired of trying to find a product for your skin which is organic
          beneficial and chemical free? Dont worry! We have got you covered!
        </div>
      </section>
      ...
      >
        ...
        <div className="flex flex-col w-3/4 gap-8 flex-1">
          ...
          <div className="text-xl mt-4 garbata text-center md:text-2xl xl:text-3xl md:text-left">
            Tired of trying to find a product for your skin which is organic
            beneficial and chemical free? Don't worry! We have got you covered!
            Reduces Oiliness, makes skin bouncy, reduces dullness and dead skin
            cells, bringing out fairer and healthier skin. Stimulates glands and
            helping drainage reduce of sebaceous bumps and sebum accumulation.
          </div>
          {/* button */}
          <button
        ...
        <div className="my-6 mt-10 max-w-7xl flex justify-center max-h-[40rem] md:gap-16 md:flex-1">
          <div className="w-3/4 mt-4">
            {productInfo[0] && (
              <ProductCarousel
                images={productInfo[0].product_image_links.description_images}
              />
            )}
          </div>
        </div>
      ...
      >
        ...
        <div className="flex flex-col w-3/4 gap-8 flex-1">
          ...
          {/* text desc */}
          <div className="text-xl mt-4 garbata text-center md:text-2xl xl:text-3xl md:text-left">
            Our body cleanser is dedicated to rejuvenate and make your dry skin
            soft, bouncy and supple again. Our cleanser contains essential
            nature sources oils which are easy to absorb by your skin which
            softens by penetration into the dermis and making it softer and
            smoother.
          </div>
          {/* button */}
          <button
      ...
      >
        ...
        <div className="text-xl mt-4 garbata text-center">
          Our body cleanser is dedicated to rejuvenate and make your dry skin
          soft, bouncy and supple again. Our cleanser contains essential nature
          sources oils which are easy to absorb by your skin which softens by
      ...
      >
        ...
        <div className="flex flex-col w-3/4 gap-8 flex-1">
          ...
          {/* text desc */}
          <div className="text-xl mt-4 garbata text-center md:text-2xl xl:text-3xl md:text-left">
            A perfect balance of essential oils and natural smoothness helping
            you in simplifying and making your bathing and skincare experience
            organic and fun.
          </div>
          {/* button */}
          <button
      ...
      >
        ...
        <div className="text-xl mt-4 garbata text-center ">
          A perfect balance of essential oils and natural smoothness helping you
          in simplifying and making your bathing and skincare experience organic
          and fun.
        </div>
        <button
          className="btn btn-lg btn-secondary my-6"
