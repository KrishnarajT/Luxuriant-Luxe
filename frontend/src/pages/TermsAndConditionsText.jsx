...
const TermsAndConditionsText = () => {
  return (
		<div className="text-xl text-center">
			...
			<div className="font-bold m-4">Agreement to Terms</div>& These Terms
			of Use constitute a legally binding agreement made between you,
			whether personally or on behalf of an entity (“you”) and Luxuriant
			Luxe , doing business as Luxuriant Luxe (“Luxuriant Luxe ’’, “we”,
			“us”, or “our”), concerning your access to and use of the
			https://luxuriaintluxe.com website as well as any other media form,
			...
			<div className="font-bold m-4">Intellectual Property Rights</div>&
			...
			use of the Site (or any portion thereof). & Products Luxuriant Luxe
			is not liable for any medical issues that may arise from using our
			products. We strongly advise conducting a patch test before using
			the product on any body part or skin type, as the reaction may vary
			depending on the individual's skin type and conditions. Although the
			products are safe for sensitive skin, we recommend taking caution,
			and in the event of any skin issues, we cannot assume
			responsibility. We make every effort to display as accurately as
			...
			actual colors and details of the products. All products are subject
			...
			accept the following forms of payment: Gpay / Phone pay and any UPI
			form of payment You agree to provide current, complete, and accurate
			...
			time. All payments shall be in U.S. dollars or the conversion to
			your local currency at that time You agree to pay all charges at the
			...
			refuse any order placed through the Site. We may, in our sole
			...
			distributors.
			<div className="font-bold m-4">Return Policy</div>& Please review
			our Return Policy posted on the Site prior to making any purchases.
			<div className="font-bold m-4">Prohibited Activities</div>& You may
			not access or use the Site for any purpose other than that for which
			we make the Site available. The Site may not be used in connection
			...
			to advertise or offer to sell goods and services. Circumvent,
			...
			of or linking to the Site. Use a buying agent or purchasing agent to
			make purchases on the Site. Trick, defraud, or mislead us and other
			...
			with any applicable laws or regulations. User Generated
			Contributions & The Site does not offer users to submit or post
			...
			of solicitation. Your Contributions are not obscene, lewd,
			lascivious, filthy, violent, harassing, libelous, slanderous, or
			otherwise objectionable (as determined by us). Your Contributions do
			not ridicule, mock, disparage, intimidate, or abuse anyone. Your
			...
			people under the age of 18 in a sexual or violent manner. Your
			...
			gender, sexual preference, or physical handicap. Your Contributions
			...
			<div className="font-bold m-4">Contribution License</div>& You and
			...
			reviews.
			<div className="font-bold m-4">Submissions</div>& You acknowledge
			and agree that any questions, comments, suggestions, ideas,
			...
			these Terms of Use, including without limitation, reporting such
			...
			<div className="font-bold m-4">Privacy Policy</div>& We care about
			data privacy and security. Please review our Privacy Policy. By
			using the Site or the Marketplace Offerings, you agree to be bound
			by our Privacy Policy, which is incorporated into these Terms of
			...
			TERMINATE YOUR USE OR PARTICIPATION IN THE SITE AND THE MARKETPLACE
			OFFERINGS OR DELETE ANY CONTENT OR INFORMATION THAT YOU POSTED AT
			ANY TIME, WITHOUT WARNING, IN OUR SOLE DISCRETION. & If we terminate
			...
			<div className="font-bold m-4">Modifications and Interruptions</div>
			...
			Site or the Marketplace Offerings. & We cannot guarantee the Site
			and the Marketplace Offerings will be available at all times. We may
			...
			other Party.
			<div className="font-bold m-4">Restrictions</div>& The Parties agree
			that any arbitration shall be limited to the Dispute between the
			Parties individually. The the full extent permitted by law, (a) no
			...
			of the site services will be at your sole risk. To the fullest
			...
			appropriate.
			<div className="font-bold m-4">Limitations of Liability</div>& In no
			...
			additional rights.
			<div className="font-bold m-4">Indemnification</div>& You agree to
			...
			managing the performance of the Site, as well as data relating to
			your use of the Site. Although we perform regular routine backups of
			...
			data. & Electronic Communications, Transactions, and Signatures &
			...
			accepting these terms and conditions, you acknowledge and agree that
			reselling AUTEU products on any third-party platform without our
			explicit authorization is strictly prohibited. This prohibition
			extends to online marketplaces, auction websites, social media
			platforms, or any other digital or physical platforms where products
			can be sold. & Consequences of Unauthorized Resale: Should you be
			found in violation of the agreement not to resell our products on
			any third-party platform, the following actions may be taken: &
			Account Suspension or Termination: We reserve the right to suspend
			or terminate your account immediately upon discovery of any
			unauthorized resale activity. This action will result in the
			restriction of your access to our products, services, and any
			associated benefits. Legal Action: You acknowledge and agree that,
			in response to the breach of the resale restriction, we may initiate
			legal action against you. Such legal action may seek damages,
			injunctions, or any other appropriate remedies to address the
			violation. By accepting these terms and conditions, you affirm your
			understanding and acceptance of the prohibition on unauthorized
			resale of our products on third-party platforms. Any breach of this
			restriction may lead to the specified consequences, including
			account suspension or termination, and potential legal
			repercussions.
			<div className="font-bold m-4">Miscellaneous</div>& These Terms of
			Use and any policies or operating rules posted by us on the Site or
			in respect to the Site constitute the entire agreement and
			...
			parties hereto to execute these Terms of Use. & Contact Us In order
			to resolve a complaint regarding the Site or to receive further
			information regarding use of the Site, please contact us here or by
			post at: Phone: +91 7666018928
		</div>
  );
};
