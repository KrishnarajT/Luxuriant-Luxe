...
const TermsAndConditionsText = () => {
  return (
    <div className="text-xl text-center">
      Terms and Conditions & Last updated January 1, 2024
      <div className="font-bold m-4">Agreement to Terms</div>& These Terms of
      Use constitute a legally binding agreement made between you, whether
      personally or on behalf of an entity (“you”) and Luxuriant Luxe , doing
      business as Luxuriant Luxe (“Luxuriant Luxe ’’, “we”, “us”, or “our”),
      concerning your access to and use of the https://luxuriaintluxe.com
      ...
      such revised Terms of Use are posted. The information provided on the Site
      ...
      if and to the extent local laws are applicable. The Site is not tailored
      to comply with industry-specific regulations (Health Insurance Portability
      ...
      would violate the Gramm-Leach-Bliley Act (GLBA). The Site is intended for
      users who are at least 18 years old. Persons under the age of 18 are not
      permitted to use or register for the Site.
      <div className="font-bold m-4">Intellectual Property Rights</div>& Unless
      ...
      written permission. Provided that you are eligible to use the Site, you
      ...
      the Marks. & User Representations By using the Site, you represent and
      warrant that: (1) you have the legal capacity and you agree to comply with
      these Terms of Use; (2) you are not a minor in the jurisdiction in which
      you reside; (3) you will not access the Site through automated or
      non-human means, whether through a bot, script or otherwise; (4) you will
      not use the Site for any illegal or unauthorized purpose; and (5) your use
      of the Site will not violate any applicable law or regulation. & If you
      ...
      thereof). & Products Luxuriant Luxe is not liable for any medical issues
      that may arise from using our products. We strongly advise conducting a
      patch test before using the product on any body part or skin type, as the
      reaction may vary depending on the individual's skin type and conditions.
      Although the products are safe for sensitive skin, we recommend taking
      caution, and in the event of any skin issues, we cannot assume
      responsibility. We make every effort to display as accurately as possible
      ...
      any products at any time for any reason. Prices for all products are
      subject to change.
      <div className="font-bold m-4">Purchases and Payment</div>& We accept the
      following forms of payment: Gpay / Phone pay and any UPI form of payment
      ...
      any time. All payments shall be in U.S. dollars or the conversion to your
      local currency at that time You agree to pay all charges at the prices
      ...
      <div className="font-bold m-4">Return Policy</div>& Please review our
      Return Policy posted on the Site prior to making any purchases.
      <div className="font-bold m-4">Prohibited Activities</div>& You may not
      access or use the Site for any purpose other than that for which we make
      ...
      without written permission from us. Make any unauthorized use of the Site,
      ...
      the Site to advertise or offer to sell goods and services. Circumvent,
      ...
      Content contained therein. Engage in unauthorized framing of or linking to
      the Site. Use a buying agent or purchasing agent to make purchases on the
      Site. Trick, defraud, or mislead us and other users, especially in any
      ...
      similar data gathering and extraction tools. Interfere with, disrupt, or
      create an undue burden on the Site or the networks or services connected
      to the Site. Attempt to impersonate another user or person or use the
      ...
      another person. Use the Site as part of any effort to compete with us or
      otherwise use the Site and/or the Content for any revenue-generating
      endeavor or commercial enterprise. Decipher, decompile, disassemble, or
      reverse engineer any of the software comprising or in any way making up a
      part of the Site. Attempt to bypass any measures of the Site designed to
      prevent or restrict access to the Site, or any portion of the Site.
      Harass, annoy, intimidate, or threaten any of our employees or agents
      engaged in providing any portion of the Site to you. Delete the copyright
      or other proprietary rights notice from any Content. Copy or adapt the
      Site’s software, including but not limited to Flash, PHP, HTML,
      JavaScript, or other code. Upload or transmit (or attempt to upload or to
      ...
      the Site or modifies, impairs, disrupts, alters, or interferes with the
      use, features, functions, operation, or maintenance of the Site. Upload or
      ...
      script or other software. Disparage, tarnish, or otherwise harm, in our
      opinion, us and/or the Site. Use the Site in a manner inconsistent with
      any applicable laws or regulations. User Generated Contributions & The
      ...
      patent, trademark, trade secret, or moral rights of any third party. You
      ...
      age of 18 in a sexual or violent manner. Your Contributions do not violate
      any applicable law concerning child pornography, or otherwise intended to
      protect the health or well-being of minors; Your Contributions do not
      ...
      <div className="font-bold m-4">Contribution License</div>& You and Site
      ...
      and your choices (including settings). & By submitting suggestions or
      other feedback regarding the Site, you agree that we can use and share
      such feedback for any purpose without compensation to you. & We do not
      ...
      <div className="font-bold m-4">Guidelines for Reviews</div>& We may
      ...
      <div className="font-bold m-4">Submissions</div>& You acknowledge and
      ...
      <div className="font-bold m-4">Site Management</div>& We reserve the
      right, but not the obligation, to: (1) monitor the Site for violations of
      these Terms of Use; (2) take appropriate legal action against anyone who,
      in our sole discretion, violates the law or these Terms of Use, including
      ...
      Marketplace Offerings.
      <div className="font-bold m-4">Privacy Policy</div>& We care about data
      privacy and security. Please review our Privacy Policy. By using the Site
      or the Marketplace Offerings, you agree to be bound by our Privacy Policy,
      which is incorporated into these Terms of Use. Please be advised the Site
      and the Marketplace Offerings are hosted in the United States. If you
      ...
      <div className="font-bold m-4">Term and Termination</div>& These Terms of
      ...
      AND USE OF THE SITE AND THE MARKETPLACE OFFERINGS (INCLUDING BLOCKING
      ...
      MARKETPLACE OFFERINGS OR DELETE ANY CONTENT OR INFORMATION THAT YOU POSTED
      AT ANY TIME, WITHOUT WARNING, IN OUR SOLE DISCRETION. & If we terminate or
      ...
      <div className="font-bold m-4">Modifications and Interruptions</div>& We
      ...
      Offerings without notice at any time. We will not be liable to you or any
      ...
      therewith.
      <div className="font-bold m-4">Governing Law</div>& Dispute Resolution
      <div className="font-bold m-4">Informal Negotiations</div>& To expedite
      ...
      the other Party.
      <div className="font-bold m-4">Restrictions</div>& The Parties agree that
      any arbitration shall be limited to the Dispute between the Parties
      individually. The the full extent permitted by law, (a) no arbitration
      ...
      above provisions concerning informal negotiations binding arbitration: (a)
      ...
      <div className="font-bold m-4">Corrections</div>& There may be information
      ...
      <div className="font-bold m-4">DISCLAIMER</div>& The site is provided on
      ...
      <div className="font-bold m-4">Limitations of Liability</div>& In no event
      ...
      <div className="font-bold m-4">Indemnification</div>& You agree to defend,
      indemnify, and hold us harmless, including our subsidiaries, affiliates,
      and all of our respective officers, agents, partners, and employees, from
      ...
      <div className="font-bold m-4">User Data</div>& We will maintain certain
      ...
      corruption of such data. & Electronic Communications, Transactions, and
      Signatures & Visiting the Site, sending us emails, and completing online
      forms constitute electronic communications. You consent to receive
      electronic communications, and you agree that all agreements, notices,
      disclosures, and other communications we provide to yelectronically, via
      ...
      <div className="font-bold m-4">Resale Prohibition</div>& By accepting
      these terms and conditions, you acknowledge and agree that reselling AUTEU
      products on any third-party platform without our explicit authorization is
      strictly prohibited. This prohibition extends to online marketplaces,
      auction websites, social media platforms, or any other digital or physical
      platforms where products can be sold. & Consequences of Unauthorized
      Resale: Should you be found in violation of the agreement not to resell
      our products on any third-party platform, the following actions may be
      taken: & Account Suspension or Termination: We reserve the right to
      suspend or terminate your account immediately upon discovery of any
      unauthorized resale activity. This action will result in the restriction
      of your access to our products, services, and any associated benefits.
      Legal Action: You acknowledge and agree that, in response to the breach of
      the resale restriction, we may initiate legal action against you. Such
      legal action may seek damages, injunctions, or any other appropriate
      remedies to address the violation. By accepting these terms and
      conditions, you affirm your understanding and acceptance of the
      prohibition on unauthorized resale of our products on third-party
      platforms. Any breach of this restriction may lead to the specified
      consequences, including account suspension or termination, and potential
      legal repercussions.
      <div className="font-bold m-4">Miscellaneous</div>& These Terms of Use and
      any policies or operating rules posted by us on the Site or in respect to
      ...
      you and us as a result of these Terms of Use or use of the Site. You agree
      ...
      by the parties hereto to execute these Terms of Use. & Contact Us In order
      to resolve a complaint regarding the Site or to receive further
      information regarding use of the Site, please contact us here or by post
      at: Phone: +91 7666018928
    </div>
  );
};
