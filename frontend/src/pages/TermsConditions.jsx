...
const TermsConditions = () => {
	return (
		<div>
			...
			<div className="text-xl m-16 text-center">
				Terms and Conditions & Last updated January 1, 2024
				<div className="font-bold m-4">Agreement to Terms</div>& These
				Terms of Use constitute a legally binding agreement made between
				you, whether personally or on behalf of an entity (“you”) and
				Luxuriant Luxe , doing business as Luxuriant Luxe (“Luxuriant
				Luxe ’’, “we”, “us”, or “our”), concerning your access to and
				use of the https://luxuriaintluxe.com website as well as any
				...
				you represent and warrant that: (1) you have the legal capacity
				and you agree to comply with these Terms of Use; (2) you are not
				a minor in the jurisdiction in which you reside; (3) you will
				not access the Site through automated or non-human means,
				whether through a bot, script or otherwise; (4) you will not use
				the Site for any illegal or unauthorized purpose; and (5) your
				...
				or future use of the Site (or any portion thereof). & Products
				Luxuriant Luxe is not liable for any medical issues that may
				arise from using our products. We strongly advise conducting a
				patch test before using the product on any body part or skin
				type, as the reaction may vary depending on the individual's
				skin type and conditions. Although the products are safe for
				sensitive skin, we recommend taking caution, and in the event of
				any skin issues, we cannot assume responsibility. We make every
				effort to display as accurately as possible the colors,
				features, specifications, and details of the products available
				on the Site. However, we do not guarantee that the colors,
				features, specifications, and details of the products will be
				accurate, complete, reliable, current, or free of other errors,
				and your electronic display may not accurately reflect the
				...
				change.
				<div className="font-bold m-4">Purchases and Payment</div>& We
				accept the following forms of payment: Gpay / Phone pay and any
				UPI form of payment You agree to provide current, complete, and
				...
				or the conversion to your local currency at that time You agree
				to pay all charges at the prices then in effect for your
				...
				distributors.
				<div className="font-bold m-4">Return Policy</div>& Please
				review our Return Policy posted on the Site prior to making any
				purchases.
				<div className="font-bold m-4">Prohibited Activities</div>& You
				...
				Site, you agree not to: Systematically retrieve data or other
				content from the Site to create or compile, directly or
				indirectly, a collection, compilation, database, or directory
				without written permission from us. Make any unauthorized use of
				the Site, including collecting usernames and/or email addresses
				...
				or under false pretenses. Use the Site to advertise or offer to
				...
				linking to the Site. Use a buying agent or purchasing agent to
				make purchases on the Site. Trick, defraud, or mislead us and
				...
				misconduct. Engage in any automated use of the system, such as
				...
				or the networks or services connected to the Site. Attempt to
				impersonate another user or person or use the username of
				another user. Sell or otherwise transfer your profile. Use any
				information obtained from the Site in order to harass, abuse, or
				harm another person. Use the Site as part of any effort to
				...
				Content. Copy or adapt the Site’s software, including but not
				limited to Flash, PHP, HTML, JavaScript, or other code. Upload
				...
				maintenance of the Site. Upload or transmit (or attempt to
				...
				collection mechanisms” or “pcms”). Except as may be the result
				...
				or offline reader that accesses the Site, or using or launching
				any unauthorized script or other software. Disparage, tarnish,
				or otherwise harm, in our opinion, us and/or the Site. Use the
				Site in a manner inconsistent with any applicable laws or
				regulations. User Generated Contributions & The Site does not
				offer users to submit or post content. We may provide you with
				...
				these Terms of Use. You have the written consent, release,
				...
				do not violate any applicable law, regulation, or rule. Your
				...
				that solicits personal information from anyone under the age of
				18 or exploits people under the age of 18 in a sexual or violent
				manner. Your Contributions do not violate any applicable law
				concerning child pornography, or otherwise intended to protect
				the health or well-being of minors; Your Contributions do not
				include any offensive comments that are connected to race,
				national origin, gender, sexual preference, or physical
				handicap. Your Contributions do not otherwise violate, or link
				to material that violates, any provision of these Terms of Use,
				or any applicable law or regulation. Any use of the Site or the
				Marketplace Offerings in violation of the foregoing violates
				these Terms of Use and may result in, among other things,
				termination or suspension of your rights to use the Site and the
				Marketplace Offerings.
				<div className="font-bold m-4">Contribution License</div>& You
				...
				settings). & By submitting suggestions or other feedback
				regarding the Site, you agree that we can use and share such
				feedback for any purpose without compensation to you. & We do
				...
				<div className="font-bold m-4">Guidelines for Reviews</div>& We
				...
				positive or negative. & We may accept, reject, or remove reviews
				...
				<div className="font-bold m-4">Submissions</div>& You
				...
				<div className="font-bold m-4">Site Management</div>& We reserve
				the right, but not the obligation, to: (1) monitor the Site for
				violations of these Terms of Use; (2) take appropriate legal
				...
				<div className="font-bold m-4">Privacy Policy</div>& We care
				about data privacy and security. Please review our Privacy
				Policy. By using the Site or the Marketplace Offerings, you
				...
				<div className="font-bold m-4">Term and Termination</div>& These
				...
				SOLE DISCRETION. & If we terminate or suspend your account for
				...
				therewith.
				<div className="font-bold m-4">Governing Law</div>& Dispute
				Resolution
				<div className="font-bold m-4">Informal Negotiations</div>& To
				...
				<div className="font-bold m-4">Restrictions</div>& The Parties
				agree that any arbitration shall be limited to the Dispute
				between the Parties individually. The the full extent permitted
				...
				<div className="font-bold m-4">Limitations of Liability</div>&
				...
				<div className="font-bold m-4">Indemnification</div>& You agree
				...
				<div className="font-bold m-4">User Data</div>& We will maintain
				certain data that you transmit to the Site for the purpose of
				managing the performance of the Site, as well as data relating
				...
				yelectronically, via email and on the Site, satisfy any legal
				...
				means.
				<div className="font-bold m-4">Resale Prohibition</div>& By
				accepting these terms and conditions, you acknowledge and agree
				that reselling AUTEU products on any third-party platform
				without our explicit authorization is strictly prohibited. This
				prohibition extends to online marketplaces, auction websites,
				social media platforms, or any other digital or physical
				platforms where products can be sold. & Consequences of
				Unauthorized Resale: Should you be found in violation of the
				agreement not to resell our products on any third-party
				platform, the following actions may be taken: & Account
				Suspension or Termination: We reserve the right to suspend or
				terminate your account immediately upon discovery of any
				unauthorized resale activity. This action will result in the
				restriction of your access to our products, services, and any
				associated benefits. Legal Action: You acknowledge and agree
				that, in response to the breach of the resale restriction, we
				may initiate legal action against you. Such legal action may
				seek damages, injunctions, or any other appropriate remedies to
				address the violation. By accepting these terms and conditions,
				you affirm your understanding and acceptance of the prohibition
				on unauthorized resale of our products on third-party platforms.
				Any breach of this restriction may lead to the specified
				consequences, including account suspension or termination, and
				potential legal repercussions.
				<div className="font-bold m-4">Miscellaneous</div>& These Terms
				of Use and any policies or operating rules posted by us on the
				Site or in respect to the Site constitute the entire agreement
				...
				Contact Us In order to resolve a complaint regarding the Site or
				to receive further information regarding use of the Site, please
				contact us here or by post at: Phone: +91 7666018928
			</div>
