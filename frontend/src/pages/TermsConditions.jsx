	...
	return (
		<div>
			...
			<div className="text-xl m-16 text-center">
				Terms and Conditions<br></br><br></br>
				Last updated January 1, 2024<br></br><br></br>
				Agreement to Terms<br></br><br></br>
				These Terms of Use constitute a legally binding agreement made
				between you, whether personally or on behalf of an entity
				(“you”) and Luxuriant Luxe , doing business as Luxuriant Luxe
				(“Luxuriant Luxe ’’, “we”, “us”, or “our”), concerning your
				access to and use of the https://luxuriaintluxe.com website as
				...
				SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY.<br></br><br></br>
				...
				not permitted to use or register for the Site.<br></br><br></br>
				Intellectual Property Rights<br></br><br></br>
				...
				Content and the Marks.<br></br><br></br>
				User Representations By using the Site, you represent and
				warrant that: (1) you have the legal capacity and you agree to
				comply with these Terms of Use; (2) you are not a minor in the
				jurisdiction in which you reside; (3) you will not access the
				Site through automated or non-human means, whether through a
				bot, script or otherwise; (4) you will not use the Site for any
				illegal or unauthorized purpose; and (5) your use of the Site
				will not violate any applicable law or regulation.<br></br><br></br>
				If you provide any information that is untrue, inaccurate, not
				current, or incomplete, we have the right to suspend or
				terminate your account and refuse any and all current or future
				use of the Site (or any portion thereof).<br></br><br></br>
				Products Luxuriant Luxe is not liable for any medical issues
				that may arise from using our products. We strongly advise
				conducting a patch test before using the product on any body
				part or skin type, as the reaction may vary depending on the
				individual's skin type and conditions. Although the products are
				safe for sensitive skin, we recommend taking caution, and in the
				event of any skin issues, we cannot assume responsibility. We
				make every effort to display as accurately as possible the
				...
				change.<br></br><br></br>
				Purchases and Payment<br></br><br></br>
				We accept the following forms of payment: Gpay / Phone pay and
				any UPI form of payment You agree to provide current, complete,
				...
				U.S. dollars or the conversion to your local currency at that
				time You agree to pay all charges at the prices then in effect
				...
				requested or received payment. We reserve the right to refuse
				any order placed through the Site. We may, in our sole
				...
				address. We reserve the right to limit or prohibit orders that,
				in our sole judgment, appear to be placed by dealers, resellers,
				or distributors.<br></br><br></br>
				Return Policy<br></br><br></br>
				Please review our Return Policy posted on the Site prior to
				making any purchases.<br></br><br></br>
				Prohibited Activities<br></br><br></br>
				...
				the Site, you agree not to: Systematically retrieve data or
				...
				regulations. User Generated Contributions<br></br><br></br>
				...
				law or regulation. Any use of the Site or the Marketplace
				Offerings in violation of the foregoing violates these Terms of
				Use and may result in, among other things, termination or
				suspension of your rights to use the Site and the Marketplace
				Offerings.<br></br><br></br>
				Contribution License<br></br><br></br>
				...
				purpose without compensation to you.<br></br><br></br>
				...
				action against us regarding your Contributions.<br></br><br></br>
				Guidelines for Reviews<br></br><br></br>
				...
				positive or negative.<br></br><br></br>
				...
				and/or distribute all content relating to reviews.<br></br><br></br>
				Submissions<br></br><br></br>
				...
				functioning of the Site and the Marketplace Offerings.<br></br><br></br>
				Privacy Policy<br></br><br></br>
				We care about data privacy and security. Please review our
				Privacy Policy. By using the Site or the Marketplace Offerings,
				you agree to be bound by our Privacy Policy, which is
				incorporated into these Terms of Use. Please be advised the Site
				and the Marketplace Offerings are hosted in the United States.
				If you access the Site or the Marketplace Offerings from any
				...
				<br></br><br></br>
				Term and Termination<br></br><br></br>
				...
				WITHOUT WARNING, IN OUR SOLE DISCRETION.<br></br><br></br>
				...
				redress.<br></br><br></br>
				Modifications and Interruptions<br></br><br></br>
				...
				therewith.<br></br><br></br>
				Governing Law<br></br><br></br>
				Dispute Resolution<br></br><br></br>
				Informal Negotiations<br></br><br></br>
				...
				notice from one Party to the other Party.<br></br><br></br>
				Restrictions<br></br><br></br>
				...
				<br></br><br></br>
				Exceptions to Informal Negotiations and Arbitration<br></br><br></br>
				...
				jurisdiction of that court.<br></br><br></br>
				Corrections<br></br><br></br>
				...
				without prior notice.<br></br><br></br>
				...
				caution where appropriate.<br></br><br></br>
				Limitations of Liability<br></br><br></br>
				...
				apply to you, and you may have additional rights.<br></br><br></br>
				...
				indemnification upon becoming aware of it.<br></br><br></br>
				User Data<br></br><br></br>
				...
				any such loss or corruption of such data.<br></br><br></br>
				...
				provide to yelectronically, via email and on the Site, satisfy
				...
				electronic means.<br></br><br></br>
				Resale Prohibition<br></br><br></br>
				By accepting these terms and conditions, you acknowledge and
				agree that reselling AUTEU products on any third-party platform
				...
				platforms where products can be sold.<br></br><br></br>
				Consequences of Unauthorized Resale: Should you be found in
				violation of the agreement not to resell our products on any
				third-party platform, the following actions may be taken:
				<br></br><br></br>
				Account Suspension or Termination: We reserve the right to
				suspend or terminate your account immediately upon discovery of
				any unauthorized resale activity. This action will result in the
				...
				potential legal repercussions.<br></br><br></br>
