		...
		<div>
			...
			<div className="flex flex-col gap-4">
				{cart.length !== 0
					? cart.map((product) => {
							return (
								<div className="flex p-4 bg-site_pink_bg m-4 mb-0">
									<div className="flex justify-center">
										<img
											src={
												isValidHttpUrl(
									...
									<div className="flex flex-col w-full">
										<div className="flex flex-col justify-center w-full">
											<div className="text-3xl droidserif font-bold m-2 mt-0 mb-0 w-full flex p-2">
											...
											<div className="text-3xl droidserif w-full flex gap-4 ml-4">
			...
			{beforeCheckoutProduct.length > 0 ? (
				<div className="flex justify-center w-full">
					<div className="flex p-4 bg-transparent m-4 mb-0 w-full">
						...
						<div className="flex flex-col w-full">
							<div className="flex justify-center w-full">
								<div className="text-3xl droidserif font-bold m-2 mt-0 w-full flex p-2">
