  ...
  return (
    <div>
                ...
                <div className="flex p-4 bg-pink-200 m-4 mb-0">
                  ...
                  <div className="flex flex-col w-full">
                    <div className="flex flex-col justify-center w-full">
                      <div className="text-3xl garbata font-bold m-2 mt-0 mb-0 w-full flex p-2">
                        ...
                        {product.product_cost === 0 ? (
                          ...
                          <div className="flex">
                            ...
                            {product.volume_present
                              ? product.selected_volume?.volume_cost
                              : product.product_cost}
                          </div>
                        )}
                      </div>
                      <div className="text-3xl garbata w-full flex gap-4 ml-4">
                        {product.volumes_present ? (
                          <div className="flex gap-4">
                            <div className="text-2xl">
                              {product.volumes_present
                                ? product.selected_volume?.volume
                                : product.product_volumes[0].volume}{" "}
                              ml
                            </div>
                          </div>
                        ) : null}
                        {product.shades_present ? (
                          <div className="text-2xl">
                            Shade:{" "}
                            {product.selected_shade?.shade_name
                              ? product.selected_shade.shade_name
                              : product.product_shades[0].shade_name}
                          </div>
                        ) : null}
                      </div>
                    </div>
                    <div className="flex flex-row justify-end gap-3 items-center my-2">
                      <div
                        ...
                        onClick={() => {
                          if (checkIfSample(product)) {
                            setSampleCount((sampleCount) => sampleCount - 1);
                          }
                      ...
                      <div
                        ...
                        onClick={() => {
                          if (!checkIfSample(product)) {
                            ...
                            toast.error("Only 1 sample can be added");
                          }
                        }}
                      >
                        <IconPlus />
                  ...
                  onClick={
                    () => {
                      if (sampleCount < 1) {
                        ...
                        if (cartTotal < 0) {
                          toast.error("Cart total should be above 0/-");
                          return;
                        }
          ...
          <div className="flex p-4 bg-transparent m-4 mb-0 w-full">
            <div className="flex justify-center">
              <img
                ...
                onClick={() => {
                  navigate(`/product/${beforeCheckoutProduct[0]._id}`);
                  // uncheck the drawer
                  let drawer_check_element =
                    document.getElementById("my-drawer");
                  drawer_check_element.checked = false;
                }}
                className="h-40 w-44 aspect-square object-center object-cover my-2"
              />
            </div>
            <div className="flex flex-col w-full">
              <div className="flex justify-center w-full">
                <div className="text-3xl garbata font-bold m-2 mt-0 w-full flex p-2">
              ...
              <div className="flex justify-end">
                <button
                  ...
                  onClick={() => {
                    // console.log(beforeCheckoutProduct);
                    if (beforeCheckoutProduct[0].product_quantity === 0) {
                      toast.error("Product is out of stock");
                      return;
                    }
      ...
      <div className="flex flex-col gap-4 uppercase ml-4 p-16">
        ...
        <div className="flex justify-between uppercase">
          <div className="text-2xl bodoni font-semibold">Points Earned</div>
          <div className="flex justify-center uppercase ml-4">
            <div className="text-2xl bodoni font-semibold flex gap-4 items-center">
              <img
                src={"https://i.imgur.com/CH68qjv.png"}
                className="w-8 h-8 object-center object-cover my-2"
              />
              {getCartPoints()}
            </div>
          </div>
        ...
        <div className="flex justify-between uppercase">
          <div className="text-2xl bodoni font-semibold">Your Points</div>
          <div className="flex justify-center uppercase ml-4">
            <div className="text-2xl bodoni font-semibold flex gap-4 items-center">
              <img
                src={"https://i.imgur.com/CH68qjv.png"}
        ...
        <div className="flex justify-between uppercase">
          <div className="text-2xl bodoni font-semibold">Discounts</div>
          <div className="flex justify-center uppercase ml-4">
            <div className="text-2xl bodoni font-semibold flex gap-4 items-center">
              <IconMinus className="w-8 h-8" />
        ...
        <div className="flex justify-between uppercase">
          <div className="text-2xl bodoni font-semibold">Final Total</div>
          <div className="flex justify-center uppercase ml-4">
            <div className="text-2xl bodoni font-semibold flex gap-4 items-center">
              <IconCurrencyRupee className="w-8 h-8" /> {getDiscountedTotal()}
            </div>
          </div>
        </div>
      </div>
