    ...
    <div id="about_div">
      ...
      >
        ...
        <div className="flex justify-center md:mx-20 md:my-4 md:hidden">
          ...
          >
            luxuriant luxe wont give you the false expectations from the product
            your natural skin will be enhanced and become more like what you
            want.
          </div>
        </div>
      </section>
      ...
      >
        <div className="md:flex md:justify-center md:flex-row md:mx-20 md:my-4">
          ...
          <div className="md:flex-1 md:flex md:p-4 md:justify-end p-4">
            <div className="rounded-3xl flex items-center 2xl:w-1/2">
              <img src={box_images[0]} alt="" className="rounded-3xl w-full" />
            </div>
          </div>
        </div>
        {/* <p
        ...
        >
          ...
          >
            ingredients. This formula won't harm your natural skin, it will only
            help you get rid of those dark spots, tan, open pores, and small
            bumps and will make your skin outrageously flawless like{" "}
          </div>
          <div className="md:flex-1 md:flex md:p-4 md:justify-start p-4">
            <div className="rounded-3xl flex items-center 2xl:w-1/2">
              <img src={box_images[1]} alt="" className="rounded-3xl" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section
        ...
        id="intro"
      >
        <div className="text-4xl md:text-5xl bodoni my-6">Only Premium</div>
        ...
        <div className="text-xl mt-4 garbata text-center">
          ...
          ingredients. This formula won't harm your natural skin, it will only
          help you get rid of those dark spots, tan, open pores, and small bumps
          and will make your skin outrageously flawless like{" "}
          <span className="text-accent garbata text-xl">
            {" "}
      ...
      >
        ...
        <div className="flex flex-col gap-16 md:flex-row md:justify-center">
          <div className="flex flex-col items-center justify-center mt-4">
            ...
            ></img>
            <div className="text-4xl text-center ">Balraj Tavanandi</div>
            <div className="text-2xl text-center ">Owner and Founder</div>
          </div>
          <div className="flex justify-center mt-4 flex-col items-center">
            <img
              ...
              className="w-screen h-64 snap-center self-center md:m-4 rounded-2xl
							md:w-80 md:h-80 bg-no-repeat bg-contain bg-center"
            ></img>
            <div className="text-4xl text-center ">Janestha Singh</div>
            <div className="text-2xl text-center ">Owner and Founder</div>
          </div>
        </div>
